      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="bg-white rounded px-2 py-1 inline-block mb-4">
              <span className="text-blue-600 font-bold text-lg">MobiusEngine</span>
            </div>
            <p className="text-blue-100 text-sm mb-4">
              Helping job seekers land their dream roles with expert coaching and resume services.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-blue-100">
              ...
              <li><a href="#" className="hover:text-white">Job Search Strategy</a></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-blue-500 flex flex-col md:flex-row justify-between items-center">
          <p className="text-blue-100 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} MobiusEngine.ai. All rights reserved.
          </p>
